...
<form  enctype="multipart/form-data" action="/model/import.do" accept-charset="UTF-8" method="post">
   	<fieldset>
		<legend contenteditable="true">Uploading Model...</legend>
		...
		<textarea id="modelcontent" name="modelcontent" class="form-control" rows="8"  placeholder="添加属性配置模态框">${modelcontent!''}</textarea>
