<div class="navbar navbar-inverse navbar-fixed-top navbar-layoutit">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="/"><span style="color: #9da5e4;"> <img
			src="/favicon.png"> JickCode </span><span class="label label-default hidden"><small>0.0.1</small></span>
		</a>
	</div>
	<div class="collapse navbar-collapse">
		...
		<ul class="nav" id="menu-layoutit" style="padding-top:15px;">
			<li class="menu-spark">			
				<span class=""   onClick="location.href='/svg/all'">Projects</span>
				<span class=""   onClick="location.href='/jnode/all'">Jnodes</span>
